      ...
      <div className="row">
        <div className="col-lg-6 mt-100 order-md-2">
          <div className="row">
            <div className="col-6 item ontop">
              <div className="img">
                <img src="/imgs/brands/01.png" alt="" />
              </div>
              <span className="top-left">
                ...
                >
                  <rect y={11} width={23} height="0.671958" fill="white" />
                  <rect
                    x={12}
                    width={23}
                    height="0.671957"
            ...
            <div className="col-6 item">
              <div className="img">
                <img src="/imgs/brands/02.png" alt="" />
              </div>
              <span className="top-right">
                <svg
                  viewBox="0 0 23 23"
        ...
        <div className="col-lg-5 offset-lg-1 md-hide">
          <div className="sec-head nocurve">
            <div className="ontop">
              <h6 className="sub-title main-color mb-15">Special Thanks To</h6>
        ...
        <div className="col-12 order-md-1">
          <div className="row">
            ...
            <div className="col-lg-3 col-6 item">
              <div className="img">
                <img src="/imgs/brands/03.png" alt="" />
              </div>
              <span className="top-right">
                <svg
                  viewBox="0 0 23 23"
            ...
            <div className="col-lg-3 col-6 item ontop">
              <div className="img">
                <img src="/imgs/brands/04.png" alt="" />
              </div>
              <span className="top-left">
                <svg
                  viewBox="0 0 23 23"
            ...
            <div className="col-lg-3 col-6 item">
              <div className="img">
                <img src="/imgs/brands/05.png" alt="" />
              </div>
              <span className="top-right">
                <svg
                  viewBox="0 0 23 23"
